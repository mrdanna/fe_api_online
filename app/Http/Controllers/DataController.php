...
class DataController extends Controller
{
    public function index() {
        ...
        if ($token) {
            ...
            $response = Http::withToken($token)->get('https://apisensor.webarokah.com/api/environment');
    ...
    public function add_action(Request $request)
    {
        ...
        $response = Http::withToken($token)
                    ->post('https://apisensor.webarokah.com/api/environment', $data);
    ...
    public function edit($id)
    {
        ...
        $response = Http::withToken($token)->get("https://apisensor.webarokah.com/api/environment/{$id}");
    ...
    public function update(Request $request, $id)
    {
        ...
        $response = Http::withToken($token)->put("https://apisensor.webarokah.com/api/environment/{$id}", $data);
    ...
    public function delete($id)
    {
        ...
        $response = Http::withToken($token)->delete('https://apisensor.webarokah.com/api/environment/' . $id);
